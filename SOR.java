...
public class SOR {
    ...
    public static String ktheSOR(int n ,double[][] A, double[] b, double[] x0, double TOL,int N, double w)
    {
     int k =1;
     double shuma =0;
     double shuma1 =0;
    ...
    public static void main(String[] args)
    {
     ...
     System.out.println("Jepni vleren e w -it: ");
     double w = input.nextDouble();
           System.out.println("Zgjidhjet jane: ");

     System.out.println(ktheSOR( n , A, b,  x0,TOL,NO, w));
    }
}
